...
const EmptyContainer = props => {
    return (React.createElement(Empty, Object.assign({}, props),
        React.createElement(Font.P, null, props.children)));
};
const Message = props => {
    return (React.createElement(ContainerMessage, Object.assign({ type: props.type }, props),
        React.createElement(Bubble, { type: props.type },
            React.createElement(Linkify, null, props.children)),
        (props.date || props.time) && (React.createElement(DateTime, null,
            props.date,
