...
;(function (overlays) {
    ...
    overlays[(overlays["overlay-gradient-black"] = 4)] =
        "overlay-gradient-black"
    overlays[(overlays["overlay-gradient-white"] = 5)] =
...
;(function (gridJustifyContent) {
    ...
    gridJustifyContent[(gridJustifyContent["space-around"] = 4)] =
        "space-around"
    gridJustifyContent[(gridJustifyContent["space-between"] = 5)] =
        "space-between"
    gridJustifyContent[(gridJustifyContent["space-evenly"] = 6)] =
        "space-evenly"
...
;(function (flexJustifyContent) {
    ...
    flexJustifyContent[(flexJustifyContent["space-between"] = 3)] =
        "space-between"
    flexJustifyContent[(flexJustifyContent["space-around"] = 4)] =
        "space-around"
    flexJustifyContent[(flexJustifyContent["space-evenly"] = 5)] =
        "space-evenly"
